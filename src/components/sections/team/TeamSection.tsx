        ...
        <section id="about-us" className="py-32 relative">
            ...
            <div className="container mx-auto px-4 2xl:px-6 max-w-7xl xl:max-w-[1400px]">
                ...
                <p className="max-w-4xl xl:max-w-5xl mx-auto text-center text-lg md:text-xl xl:text-2xl text-foreground/80 mb-16 leading-relaxed">
                    Our team is composed of dedicated professionals committed to delivering exceptional value through innovation and technical excellence. We combine deep industry knowledge with cutting-edge technology to solve complex business challenges.
                </p>
                            ...
                            {teamMembers.map((m, i) => (
                                ...
                                >
                                    <div className="p-1 rounded-[28px] bg-blue-500/5 backdrop-blur-sm">
                                        <div
                                            onClick={() => setActive(m)}
                                            className={`relative w-full overflow-hidden rounded-3xl border transition-all duration-500 group cursor-pointer ${selected?.id === m.id
