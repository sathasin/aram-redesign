      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-secondary-foreground/70 mb-12 max-w-2xl mx-auto">
            Whether you are embarking on a comprehensive digital transformation, solving a specific business challenge, 
            or exploring emerging technologies, we are here to help you succeed.
          </p>
